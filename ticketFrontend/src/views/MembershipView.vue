...
const benefitSteps = [
  ...
  },
  {
    ...
    description:
      "Keep passes, ticket history, and membership perks in one profile hub.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Most TicketRush-hosted events are included. Some organizer-specific exclusives may have different terms listed on the event page.",
  },
  {
    id: 3,
        ...
        <div class="grid gap-10 lg:grid-cols-[1.25fr_0.9fr] items-center">
          <div>
            ...
            <h1 class="text-4xl md:text-6xl font-black tracking-tight leading-none max-w-3xl">
              Book smarter, move faster, and get more from every event.
            </h1>
